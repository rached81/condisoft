...
$(document).ready(function() {
    ...
    $("#con").blur(function() {
        ...
        if ($("#con").val().length > 0) {
            param.con = $("#con").val();
            get_ajax_data("/etatgen/asyn_get_base_mysql", param, "populate_base");
        }
    ...
    $("#BASE").change(function() {
        ...
        if ($("#BASE").val().length > 0) {
            ...
            if ($("#con").val().length > 0) {
                param.con = $("#con").val();
                get_ajax_data("/etatgen/asyn_get_table_mysql", param, "populate_table");
            }
        }
...
function get_shema() {
    ...
    if ($("#sgbd").val() == "mysql") {
        get_ajax_data("/etatgen/asyn_get_shema_mysql", param, "get_shema_pupulate");
    } else if ($("#sgbd").val() == "db2") {
        get_ajax_data("/etatgen/asyn_get_shema_db2", param, "get_shema_pupulate");
    }
...
function get_shema_pupulate(data) {
    ...
    if (data["etat"] == "0") {
        ...
        $.each(datas, function(index, elm) {
            ...
            html += '<div class="input-group input-group-sm connect-table">'
...
function compiler(name) {
    ...
    get_ajax_data("/etatgen/asyn_compile", param, false);
