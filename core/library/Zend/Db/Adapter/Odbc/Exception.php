...
/**
 * Zend_Db_Adapter_Odbc_Exception
 *
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Adapter
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Db_Adapter_Odbc_Exception extends Zend_Db_Adapter_Exception
{
    /**
     * Constructor
     *
     * If $message is an array, the assumption is that the return value of
     * odbc_errors() was provided. If so, it then retrieves the most recent
