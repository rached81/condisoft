 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Db_Adapter_Odbc_Oracle extends Zend_Db_Adapter_Odbc_Abstract
{
    /**
     * Odbc type.
     *
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'Zend_Db_Statement_Odbc_Oracle';
