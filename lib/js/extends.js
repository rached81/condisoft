...
$().ready(function () {
    ...
    $.extend({buildTable: function (elm, titre, table, btn, tot) {

            var html = '<table class="tablesorter table-hover  table table-striped  tablesorter-bootstrap" id="expexcel' + guid() + '">'
            html += '<thead>'
